...
const NAV_ITEMS = [
  ...
  { to: "/admin/employees", label: "Employees", icon: LuUsers },
  { to: "/admin/skills", label: "Skills", icon: LuSparkles },
  { to: "/admin/services", label: "Services", icon: LuBriefcase },
  { to: "/admin/experience", label: "Experience", icon: LuBriefcase },
  { to: "/admin/education", label: "Education", icon: LuGraduationCap },
  { to: "/admin/certifications", label: "Certifications", icon: LuAward },
  { to: "/admin/contact-info", label: "Contact Info", icon: LuMail },
  { to: "/admin/projects", label: "Projects", icon: LuFolderKanban },
  { to: "/admin/tasks", label: "Tasks", icon: LuListChecks },
  { to: "/admin/attendance", label: "Attendance", icon: LuClock },
  { to: "/admin/leaves", label: "Leave Requests", icon: LuCalendarClock },
  { to: "/admin/reviews", label: "Reviews", icon: LuMessageSquare },
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="px-5 py-6 border-b border-ink-700">
        <p className="font-display text-lg font-semibold text-cloud-100">Portfolio Admin</p>
      ...
      <div className="flex">
        ...
        <div className="flex-1 min-w-0">
          ...
          <header className="sticky top-0 z-30 flex items-center justify-between border-b border-ink-700 bg-ink-900/80 backdrop-blur px-4 sm:px-6 py-3.5">
            ...
            <p className="font-display text-sm text-cloud-300 lg:hidden">Admin</p>
            <div className="hidden lg:block" />
            <button
              className="lg:hidden p-2 rounded-lg text-cloud-300 hover:bg-ink-700 opacity-0 pointer-events-none"
              aria-hidden="true"
            >
