    ...
    <div className="min-h-screen flex items-center justify-center bg-ink-950 bg-grid px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <p className="font-display text-2xl font-semibold text-cloud-100">Employee Portal</p>
          <p className="text-sm text-cloud-400 mt-1">Sign in to manage your profile & tasks</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card-surface p-6 sm:p-8 space-y-5">
          ...
          <p className="text-xs text-cloud-500 -mt-2">
            Employee accounts are created by an admin — contact them if you don&apos;t have credentials yet.
          </p>
